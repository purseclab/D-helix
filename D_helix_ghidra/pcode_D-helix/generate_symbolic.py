...
def main_each_program(filename):
    ...
    '''
    if os.path.isfile(filepath_generated_html):
       print("file exits")
       pass
    else:
    ...
    try:
       ...
       print("cannot open func:"+filepath_generated_function_name)
       return
    ...
    try:
       ...
       print("canot open func_c:"+filepath_generated_whole_c)
       return    
    '''
