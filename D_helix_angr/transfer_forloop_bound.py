...
transferfuncname = "/home/muqi/pthread_Angr_Prompt_angr_rest_analysis/function_name/"
transfertestmuqi = "/home/muqi/pthread_Angr_Prompt_angr_rest_analysis/test_muqi/"
directoriginclang = "./test_muqi/originalclang/"
transferfunccount = "/home/muqi/pthread_Angr_Prompt_angr_rest_analysis/function_count/"
...
def main_each_program(filename):
    ...
    for i in range(len(functionnames)):
        ...
        filepath_modeified_c = "./test_muqi/generated_function_c/project_folder/"+filename+"_folder/"+filename+"_"+function_name+".c"
