...
'''
directfuncname = "../function_name_arm/"
directoriginal = "../test_muqi/originalclang"
transferfuncname = "/home/muqi/pthread_Angr_Prompt_count_arm_angr/function_name/"
transfertestmuqi = "/home/muqi/pthread_Angr_Prompt_count_arm_angr/test_muqi/"
directoriginclang = "../test_muqi/originalclang/"
transferfunccount = "/home/muqi/pthread_Angr_Prompt_count_arm_angr/function_count/"
...
def main_each_program(filename):
    ...
    for i in range(len(functionnames)):
        ...
        filepathz3 = "../test_muqi/z3_all/"+filename+"_"+function_name+"_z3"
        filepathz3_unsat = "../test_muqi/z3_all/"+filename+"_"+function_name+"_z3_unsat"
        ...
        if True:
            ...
            if False:
                ...
                for j in range(len(functionc_lines)):
                    if function_name in functionc_lines[j] and "{" in functionc_lines[j+1] and  "}" in functionc_lines[j+2]:
                        abort += 1        
                        break
                    if function_name in functionc_lines[j] and "{" in functionc_lines[j+1] and  "goto" in functionc_lines[j+2] and "}" in functionc_lines[j+3]:
                        abort += 1
                        break
