...
undefined8 handle_ack(long param_1,int param_2)
...
//comment in_FS_OFFSET
  if (*(int *)(param_1 + 0x40) != param_2) {
    if ((uint)(param_2 - *(int *)(param_1 + 0x40)) < 0x2711) {
      if ((uint)(*(int *)(param_1 + 0x34) - param_2) < 0x2711) {
        *(int *)(param_1 + 0x40) = param_2;
        uVar1 = 1;
      }
      else {
        ipaddress_fmt(auStack104);
        LOG(4,"%s - tcb: ackno from future: my seqno = 0x%08x, their ackno = 0x%08x\n",auStack104,
            *(undefined4 *)(param_1 + 0x34),param_2);
      }
    }
    else {
      ipaddress_fmt(auStack104);
      LOG(4,"%s - tcb: ackno from past: old ackno = 0x%08x, this ackno = 0x%08x\n",auStack104,
