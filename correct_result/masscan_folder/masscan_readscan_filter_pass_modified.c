...
bool readscan_filter_pass(undefined4 param_1,undefined4 param_2,long param_3,long param_4)

{
  int iVar1;
  
  if ((param_3 != 0) &&
     (((*(long *)(param_3 + 0x78) != 0 && (iVar1 = massip_has_ip(param_3), iVar1 == 0)) ||
      ((*(long *)(param_3 + 0x70) != 0 && (iVar1 = massip_has_port(param_3,param_1), iVar1 == 0)))))
     ) {
    return false;
  }
  if ((param_4 != 0) && (*(int *)(param_4 + 8) != 0)) {
    iVar1 = rangelist_is_contains(param_4,param_2);
    return iVar1 != 0;
  }
  return true;
}
