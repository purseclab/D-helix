...
bool gxf_compare_field_nb(long param_1,long param_2,long param_3)

{
  ...
  lVar4 = *(long *)(lVar2 + (long)*(int *)(param_3 + 0x24) * 8);
  lVar5 = *(long *)(lVar4 + 8);
  if (**(int **)(lVar4 + 0xd0) == 1) {
    uVar6 = av_rescale_rnd(uVar7,(long)*(int *)(lVar3 + 0x30),(long)*(int *)(lVar3 + 0x2c) * 48000,3
                          );
    uVar7 = (ulong)(uVar6 & 0xfffffffe);
  }
  lVar2 = *(long *)(lVar2 + (long)*(int *)(param_2 + 0x24) * 8);
  lVar4 = *(long *)(lVar2 + 8);
  uVar6 = (uint)*(undefined8 *)(param_2 + 0x10);
  if (**(int **)(lVar2 + 0xd0) == 1) {
    uVar6 = av_rescale_rnd(*(undefined8 *)(param_2 + 0x10),(long)*(int *)(lVar3 + 0x30),
                           (long)*(int *)(lVar3 + 0x2c) * 48000,3);
    uVar6 = uVar6 & 0xfffffffe;
  }
  bVar8 = true;
  if (((int)uVar6 <= (int)(uint)uVar7) && (bVar8 = false, uVar6 == (uint)uVar7)) {
    uVar6 = *(uint *)(lVar5 + 0x3c);
    puVar1 = (uint *)(lVar4 + 0x3c);
    return uVar6 <= *puVar1 && *puVar1 != uVar6;
  }
  return bVar8;
}
