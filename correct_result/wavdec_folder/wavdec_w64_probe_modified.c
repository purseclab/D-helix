...
int uRam4808488b48108b48; //add global variable by muqi
int uRam20488b4818508b48; //add global variable by muqi
int uRam20488b4818508b50; //add global variable by muqi
int uRam4808488b48108b50; //add global variable by muqi
typedef int code;
...
undefined8 w64_probe(long param_1)

{
  ulong *puVar1;
  
  if (((0x28 < *(int *)(param_1 + 0x10)) &&
      (puVar1 = *(ulong **)(param_1 + 8),
      (puVar1[1] ^ uRam4808488b48108b50 | *puVar1 ^ uRam4808488b48108b48) == 0)) &&
     ((puVar1[4] ^ uRam20488b4818508b50 | uRam20488b4818508b48 ^ puVar1[3]) == 0)) {
    return 100;
  }
  return 0;
}
