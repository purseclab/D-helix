...

{
  ...
  bVar2 = 0;
  if (0x7f < *(int *)(param_1 + 0x10)) {
    lVar1 = *(long *)(param_1 + 8);
    if ((((*(ushort *)(lVar1 + 4) - 0xaf11 < 2) || (bVar2 = 0, *(ushort *)(lVar1 + 4) == 0xaf44)) &&
        ((*(short *)(lVar1 + 0x10) == -0xe06 || (bVar2 = 0, *(uint *)(lVar1 + 0x10) < 0x7d1)))) &&
       (bVar2 = 0, *(ushort *)(lVar1 + 8) < 0x1001)) {
      bVar2 = -(*(ushort *)(lVar1 + 10) < 0x1001) & 99;
    }
  }
  return bVar2;
}
