...
undefined8 daud_write_packet(long param_1,long param_2)

{
  undefined8 uVar1;
  
  if (*(int *)(param_2 + 0x20) < 0x10000) {
    avio_wb16(*(undefined8 *)(param_1 + 0x20));
    avio_wb16(*(undefined8 *)(param_1 + 0x20),0x8010);
    avio_write(*(undefined8 *)(param_1 + 0x20),*(undefined8 *)(param_2 + 0x18),
               *(undefined4 *)(param_2 + 0x20));
    uVar1 = 0;
  }
  else {
    av_log(param_1,0x10,"Packet size too large for s302m. (%d > 65535)\n",*(int *)(param_2 + 0x20));
    uVar1 = 0xbebbb1b7;
  }
  return uVar1;
}
