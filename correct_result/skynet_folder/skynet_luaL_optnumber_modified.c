...
void luaL_optnumber(undefined8 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  uVar1 = lua_type(param_9,param_10);
  if ((int)uVar1 < 1) {
    return;
  }
  luaL_checknumber(param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9,param_10,
