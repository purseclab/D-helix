...
int muzzy_decay_ms_default; //add global variable by muqi
typedef int code;
...
undefined8 je_arena_muzzy_decay_ms_default_set(char* param_1)

{
  if ((-2 < param_1) && (param_1 + 1U < 0x10c6f7a0af42)) {
    muzzy_decay_ms_default = param_1;
    return 0;
  }
  return 1;
}
