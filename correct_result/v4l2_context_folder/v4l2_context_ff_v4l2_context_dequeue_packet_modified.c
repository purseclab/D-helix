...
ulong ff_v4l2_context_dequeue_packet(long param_1,undefined8 param_2)

{
  long lVar1;
  ulong uVar2;
  
  lVar1 = v4l2_dequeue_v4l2buf(param_1,0xffffffff);
  if (lVar1 != 0) {
    uVar2 = ff_v4l2_buffer_buf_to_avpkt(param_2,lVar1);
    return uVar2;
  }
