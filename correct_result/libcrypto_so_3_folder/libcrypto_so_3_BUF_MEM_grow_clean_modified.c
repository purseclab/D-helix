...
ulong BUF_MEM_grow_clean(ulong *param_1,ulong param_2)

{
  ...
  if (param_2 <= uVar1) {
    if (param_1[1] != 0) {
      memset(param_1[1] + param_2,0,uVar1 - param_2);
    }
    goto LAB_0021cff1;
  }
  if (param_2 <= param_1[2]) {
    memset(param_1[1] + uVar1,0,param_2 - uVar1);
    *param_1 = param_2;
    return param_2;
  }
  if (0x5ffffffc < param_2) {
    ERR_new();
    uVar3 = 0x80;
    goto LAB_0021d031;
  }
  ...
  if ((*(byte *)(param_1 + 3) & 1) == 0) {
    uVar2 = CRYPTO_clear_realloc(param_1[1],param_1[2],uVar1,"crypto/buffer/buffer.c",0x87);
LAB_0021cfcc:
    if (uVar2 == 0) {
LAB_0021d090:
      ERR_new();
      uVar3 = 0x89;
LAB_0021d031:
      ERR_set_debug("crypto/buffer/buffer.c",uVar3,"BUF_MEM_grow_clean");
      ERR_set_error(7,0xc0100,0);
      return 0;
    }
  }
  else {
    uVar2 = CRYPTO_secure_malloc(uVar1,"crypto/buffer/buffer.c",0x3e);
    if (param_1[1] == 0) goto LAB_0021cfcc;
    if (uVar2 == 0) goto LAB_0021d090;
    memcpy(uVar2,param_1[1],*param_1);
    CRYPTO_secure_clear_free(param_1[1],*param_1,"crypto/buffer/buffer.c",0x42);
  }
  param_1[1] = uVar2;
  param_1[2] = uVar1;
  memset(*param_1 + uVar2,0,param_2 - *param_1);
LAB_0021cff1:
  *param_1 = param_2;
  return param_2;
}
