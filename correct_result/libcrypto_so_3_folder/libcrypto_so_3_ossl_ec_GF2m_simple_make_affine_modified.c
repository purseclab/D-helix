...
int ossl_ec_GF2m_simple_make_affine(undefined8 param_1,long param_2,long param_3)

{
  ...
  if ((*(int *)(param_2 + 0x28) == 0) && (iVar1 = EC_POINT_is_at_infinity(), iVar1 == 0)) {
    lVar6 = 0;
    if ((param_3 != 0) || (param_3 = BN_CTX_new(), lVar6 = param_3, param_3 != 0)) {
      BN_CTX_start(param_3);
      uVar3 = BN_CTX_get(param_3);
      lVar4 = BN_CTX_get(param_3);
      if ((((lVar4 != 0) &&
           (iVar2 = EC_POINT_get_affine_coordinates(param_1,param_2,uVar3,lVar4,param_3), iVar2 != 0
           )) && (lVar5 = BN_copy(*(undefined8 *)(param_2 + 0x10),uVar3), lVar5 != 0)) &&
         ((lVar4 = BN_copy(*(undefined8 *)(param_2 + 0x18),lVar4), lVar4 != 0 &&
          (iVar2 = BN_set_word(*(undefined8 *)(param_2 + 0x20),1), iVar2 != 0)))) {
