...
undefined8 wsaud_write_packet(long param_1,long param_2)

{
  ...
  if (*(int *)(param_2 + 0x20) < 0x4000) {
    avio_wl16(uVar3);
    avio_wl16(uVar3,*(int *)(param_2 + 0x20) * 4);
    avio_wl32(uVar3,0xdeaf);
    avio_write(uVar3,*(undefined8 *)(param_2 + 0x18),*(undefined4 *)(param_2 + 0x20));
    iVar1 = *(int *)(param_2 + 0x20);
    piVar2[1] = piVar2[1] + iVar1 + 8;
    *piVar2 = *piVar2 + iVar1 * 4;
    uVar3 = 0;
  }
  else {
    uVar3 = 0xbebbb1b7;
