...
undefined4 statvfs_works_cache_2444 = 0xFFFFFFFF ; //based on value of ghidra, add global variable tagged by muqi
typedef int code;
...
//comment in_FS_OFFSET
  if ((int)statvfs_works_cache_2444 < 0) {
    iVar1 = uname(&local_198);
    if ((iVar1 == 0) && (iVar1 = strverscmp(local_198.release,"2.6.36"), -1 < iVar1)) {
      statvfs_works_cache_2444 = 1;
    }
    else {
      statvfs_works_cache_2444 = 0;
    }
  }
if (1) {
    return statvfs_works_cache_2444 & 0xffffffff;
  }
