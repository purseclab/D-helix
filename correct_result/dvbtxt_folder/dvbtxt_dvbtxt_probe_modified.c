...

{
  ...
  iVar2 = (*(int *)(param_1 + 0x10) + 0x2d) % 0xb8;
  if (iVar2 != 0) {
    return 0;
  }
  pbVar1 = *(byte **)(param_1 + 8);
  if ((*pbVar1 - 0x10 < 0x10) || (*pbVar1 - 0x99 < 3)) {
    pbVar3 = pbVar1 + 1;
    while( true ) {
      if (pbVar1 + *(int *)(param_1 + 0x10) <= pbVar3) {
        return 0x32;
      }
      if (((1 < *pbVar3 - 2) && (*pbVar3 != 0xff)) || (pbVar3[1] != 0x2c)) break;
      pbVar3 = pbVar3 + 0x2e;
    }
  }
  return iVar2;
