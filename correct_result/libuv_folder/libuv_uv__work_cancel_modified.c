...
int mutex; //add global variable by muqi
int uv__cancelled; //add global variable by muqi
int register0x00000020; //add global variable by muqi
typedef int code;
...
undefined8 uv__work_cancel(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  undefined8 uStack80;
  undefined8 uStack72;
  undefined8 auStack64 [6];
  int local_c;
  long *plStack8;
  
  puVar4 = (undefined8 *)((long)register0x00000020 - 8);
  *puVar4 = unaff_RBP;
  puVar4[-3] = param_1;
  puVar4[-4] = param_2;
  puVar4[-5] = param_3;
  *(undefined8 *)(((long)puVar4 - 0x30) - 8) = 0x10cdb7;
  uv_mutex_lock(mutex);
  lVar1 = *(long *)(puVar4[-5] + 0x10);
  puVar5 = (undefined8 *)((long)((undefined8 *)(((long)puVar4 - 0x30) - 8) + 1) - 8);
  *puVar5 = 0x10cdcd;
  uv_mutex_lock(lVar1 + 0x88);
  if (((puVar4[-5] + 0x18) - *(long *)(puVar4[-5] + 0x18) == 0) || (*(long *)puVar4[-5] == 0)) {
    uVar2 = 0;
  }
  else {
    uVar2 = 1;
  ...
  *(undefined4 *)((long)puVar4 + -4) = uVar2;
  if (*(int *)((long)puVar4 + -4) - 0 != 0) {
    **(undefined8 **)(puVar4[-5] + 0x20) = *(undefined8 *)(puVar4[-5] + 0x18);
    *(undefined8 *)(*(long *)(puVar4[-5] + 0x18) + 8) = *(undefined8 *)(puVar4[-5] + 0x20);
  }
  lVar1 = *(long *)(puVar4[-5] + 0x10);
  puVar6 = (undefined8 *)((long)(puVar5 + 1) - 8);
  *puVar6 = 0x10ce4f;
  uv_mutex_unlock(lVar1 + 0x88);
  puVar7 = (undefined8 *)((long)(puVar6 + 1) - 8);
  *puVar7 = 0x10ce5b;
  ...
  if (*(int *)((long)puVar4 + -4) - 0 == 0) {
    ...
    *(code **)puVar4[-5] = uv__cancelled;
    lVar1 = puVar4[-3];
    puVar8 = (undefined8 *)((long)(puVar7 + 1) - 8);
    *puVar8 = 0x10ce8b;
    uv_mutex_lock(lVar1 + 0x88);
    *(long *)(puVar4[-5] + 0x18) = puVar4[-3] + 0x78;
    *(undefined8 *)(puVar4[-5] + 0x20) = *(undefined8 *)(puVar4[-3] + 0x80);
    **(long **)(puVar4[-5] + 0x20) = puVar4[-5] + 0x18;
    *(long *)(puVar4[-3] - -0x80) = puVar4[-5] + 0x18;
    lVar1 = puVar4[-3];
    puVar9 = (undefined8 *)((long)(puVar8 + 1) - 8);
    *puVar9 = 0x10cef2;
    uv_async_send(lVar1 + 0xb0);
    lVar1 = puVar4[-3];
    *(undefined8 *)((long)(puVar9 + 1) - 8) = 0x10cf04;
    uv_mutex_unlock(lVar1 + 0x88);
    uVar3 = 0;
  }
  return uVar3;
