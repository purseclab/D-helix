...
directname_z3_all = "./test_muqi/z3_all"
...
def z3_each_file(filename):
    ...
    filepath_z3_all = os.path.join(directname_z3_all,filename)
    ...
    run_cmd("z3 "+filepath_z3_fourth_cfgfast+" > "+filepath_diff, 30)
...
def main():
    ...
    '''
    pool = Pool()
    pool.map(z3_each_file, os.listdir(directname_z3_fourth_cfgfast))
    #'''
