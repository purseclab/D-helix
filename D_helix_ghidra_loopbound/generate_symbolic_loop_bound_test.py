...
def main_each_function_klee(i,function_name_list,filename,filepath_originalclang):
    ...
    if os.path.isfile(filepath_generatedbc)  :
        ...
        if 'terminating state' in last_line :
            ...
            print("/home/muqi/PROMPT_loop_bound/build/bin/klee  -prose-api-model="+filepath_prompt_model_on_function+ "  --loop-bound=2  --search=bfs --solver-backend=z3 --posix-runtime " + filepath_generatedbc + ' 1> '+ filepath_log_klee +' 2> '+ filepath_log_klee_error)
