...
def write_log_to_file(fout,linelistdiff,linelistz3,filename):
    ...
    print_or_not_nodouble = check_void(directname_function_content,individual_functionname) or check_pointer_return(directname_function_content,individual_functionname) or check_same_block_id (linelistz3)
    if (print_or_not_nodouble == False):
