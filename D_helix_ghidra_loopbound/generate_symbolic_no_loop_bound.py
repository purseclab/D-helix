    ...
    if os.path.isfile(filepath_generatedbc)  :
        ...
        if 'terminating state' in last_line :
            ...
            if foreverloop == False:
               ...
               run_cmd("/home/muqi/PROMPT/build/bin/klee  -prose-api-model="+filepath_prompt_model_on_function+ "   --search=bfs --solver-backend=z3 --posix-runtime " + filepath_generatedbc + ' 1> '+ filepath_log_klee +' 2> '+ filepath_log_klee_error,20)
